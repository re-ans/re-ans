...
<p align="center">
  <em>Building full-stack solutions with a focus on machine learning and scalable APIs.</em>
</p>
...
`React` • `Flask` • `PyTorch` • `OpenCV` • `NumPy`

**Tools & Platforms:**  
`Git` • `Docker` • `Firebase` • `MongoDB` • `Figma`
...
---
### 📬 Connect With Me
<div align="center"><a href="mailto:anngo@utexas.edu"><img src="https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white" alt="Email Badge" /></a> <a href="https://www.linkedin.com/in/anngo1006/"><img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn Badge" /></a></div>
